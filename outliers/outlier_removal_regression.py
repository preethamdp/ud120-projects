...
print("score_with_test_data:",reg.score(ages_test,net_worths_test))
...
if len(cleaned_data) > 0:
    ...
    try:
        ...
        print("slope_after_outlier_removal:",reg.coef_)
        print("score_after_outlier_removal:",reg.score(ages_test,net_worths_test))
